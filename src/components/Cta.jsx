  ...
  return (
    <div className="cta">
      ...
      <div className="cta__Menu">
        <span className="sm:text-[1.9512195122vw] sm:leading-[3.41463414634vw] lg:text-[0.9375vw] lg:leading-[1.45833333333vw] PingAR-Light text-[#FFFFFF] leading-[5.64102564103vw] text-[3.58974358974vw]">
          Book an Appointment
        </span>
        <div className="sm:mt-[1.9512195122vw] sm:gap-y-[1.46341463415vw] text-[#FFFFFF] flex items-center mt-[4.10256410256vw] lg:mt-[0.83333333333vw] flex-col lg:gap-y-[0.625vw] gap-y-[3.07692307692vw]">
          ...
          >
            <div className="sm:h-[2.19512195122vw] flex lg:gap-x-[0.41666666666vw] gap-x-[2.05128205128vw] lg:h-[1.04166666667vw]">
              <span className="sm:text-[1.82926829268vw] PingAR-Light lg:text-[0.9375vw] text-[3.07692307692vw]">
                Get app
              </span>
              <img
