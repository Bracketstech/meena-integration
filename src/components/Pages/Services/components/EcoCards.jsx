    ...
    >
      ...
      >
        <div className="sm:w-[90%] sm:gap-y-[1.9512195122vw] lg:w-[19.1666666667vw] w-[76.4102564103vw] mx-[auto] flex flex-col items-center lg:gap-y-[0.83333333333vw] gap-y-[4.5vw]">
          <img
            src="/images/services/ecosystem/1.svg"
            alt="ecosystem"
          ...
          <div className="text-center">
            ...
            <p className="sm:text-[2.19512195122vw] sm:leading-[3.65853658537vw] sm:mt-[1.46341463415vw] lg:text-[0.9375vw] lg:leading-[1.45833333333vw] text-[3.58974358974vw] leading-[6.15384615385vw] text-[#505050] PingAR-Regular lg:mt-[0.41666666666vw] mt-[2.05128205128vw]">
              {arabic
                ? "عيادات تقع بالقرب منك ، في أحيائك والمناطق العامة الخاصة بك ، ومن خلال هاتفك"
                : "Clinics located near you, in your neighborhoods and your communal areas, and through your phone"}
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="sm:w-[90%] sm:gap-y-[1.9512195122vw] lg:w-[19.1666666667vw] w-[76.4102564103vw] mx-[auto] flex flex-col items-center lg:gap-y-[0.83333333333vw] gap-y-[4.5vw]">
          <img
            src="/images/services/ecosystem/2.svg"
            alt="ecosystem"
            className="lg:w-[2.03125vw] w-[7.69230769231vw] sm:w-[4.268292682926829vw]"
          />
          <div className="text-center">
            <h5 className="sm:text-[2.68292682927vw] sm:leading-[3.90243902439vw] lg:text-[1.354166666666667vw] lg:leading-[2.1875vw] PingAR-Bold text-[4.87179487179vw] leading-[7.69230769231vw] text-[#845FFF]">
            ...
            <p className="sm:text-[2.19512195122vw] sm:leading-[3.65853658537vw] sm:mt-[1.46341463415vw] lg:text-[0.9375vw] lg:leading-[1.45833333333vw] text-[3.58974358974vw] leading-[6.15384615385vw] text-[#505050] PingAR-Regular lg:mt-[0.41666666666vw] mt-[2.05128205128vw]">
              {arabic
                ? "مركز رعاية عاجلة يقدم الرعاية الطارئة عند الحاجة إليها"
      ...
      >
        <div className="sm:w-[90%] sm:gap-y-[1.9512195122vw] lg:w-[19.1666666667vw] w-[76.4102564103vw] mx-[auto] flex flex-col items-center lg:gap-y-[0.83333333333vw] gap-y-[4.5vw]">
          <img
            src="/images/services/ecosystem/3.svg"
            alt="ecosystem"
            className="lg:w-[3.75vw]"
          />
          <div className="text-center">
            <h5 className="sm:text-[2.68292682927vw] sm:leading-[3.90243902439vw] lg:text-[1.354166666666667vw] lg:leading-[2.1875vw] PingAR-Bold text-[4.87179487179vw] leading-[7.69230769231vw] text-[#845FFF]">
            ...
            <p className="sm:text-[2.19512195122vw] sm:leading-[3.65853658537vw] sm:mt-[1.46341463415vw] lg:text-[0.9375vw] lg:leading-[1.45833333333vw] text-[3.58974358974vw] leading-[6.15384615385vw] text-[#505050] PingAR-Regular lg:mt-[0.41666666666vw] mt-[2.05128205128vw]">
              {arabic
                ? "إدارة رحلة الرعاية بما في ذلك المتابعة والتوصيات والإحالات التي ييسرها منسقو الرعاية"
                : "Care journey management including follow ups, recommendations and referrals facilitated by care coordinators"}
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="sm:w-[90%] sm:gap-y-[1.9512195122vw] lg:w-[19.1666666667vw] w-[76.4102564103vw] mx-[auto] flex flex-col items-center lg:gap-y-[0.83333333333vw] gap-y-[4.5vw]">
          <img
            src="/images/services/ecosystem/4.svg"
            alt="ecosystem"
            className="lg:w-[2.91666666667vw] w-[11.5384615385vw] sm:w-[6.707317073170732vw]"
          />
          <div className="text-center">
            <h5
              id="lineanimation3"
            ...
            <p className="sm:text-[2.19512195122vw] sm:leading-[3.65853658537vw] sm:mt-[1.46341463415vw] lg:text-[0.9375vw] lg:leading-[1.45833333333vw] text-[3.58974358974vw] leading-[6.15384615385vw] text-[#505050] PingAR-Regular lg:mt-[0.41666666666vw] mt-[2.05128205128vw]">
              {arabic
                ? "رعاية متكاملة في متناول يدك من خلال تطبيق الهاتف المحمول الخاص بنا ، حيث يمكنك الوصول إلى الوصفات الطبية الإلكترونية وتقارير التصوير والتشخيصات والاستشارات عن بُعد"
                : "Integrated care at your fingertips through our mobile app, where you can access e-prescriptions, imaging reports, diagnostics, and teleconsultations"}
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="sm:w-[90%] sm:gap-y-[1.9512195122vw] lg:w-[19.1666666667vw] w-[76.4102564103vw] mx-[auto] flex flex-col items-center lg:gap-y-[0.83333333333vw] gap-y-[4.5vw]">
          <img
            src="/images/services/ecosystem/5.svg"
            alt="ecosystem"
            className="lg:w-[2.91666666667vw] w-[11.5384615385vw] sm:w-[5.365853658536585vw]"
          />
          <div className="text-center">
            <h5 className="sm:text-[2.68292682927vw] sm:leading-[3.90243902439vw] lg:text-[1.354166666666667vw] lg:leading-[2.1875vw] PingAR-Bold text-[4.87179487179vw] leading-[7.69230769231vw] text-[#845FFF]">
            ...
            <p className="sm:text-[2.19512195122vw] sm:leading-[3.65853658537vw] sm:mt-[1.46341463415vw] lg:text-[0.9375vw] lg:leading-[1.45833333333vw] text-[3.58974358974vw] leading-[6.15384615385vw] text-[#505050] PingAR-Regular lg:mt-[0.41666666666vw] mt-[2.05128205128vw]">
              {arabic
                ? "التصوير والاختبار والتصوير السريع في العيادة والاستغناء عن الأدوية بأحدث المرافق"
                : "Rapid, in-clinic imaging, testing, and medication dispensing with state-of-the-art facilities"}
            </p>
          </div>
        </div>
      </div>
