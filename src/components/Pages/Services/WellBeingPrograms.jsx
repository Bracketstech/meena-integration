...
const WellBeingPrograms = ({ arabic }) => {
  return (
    <div className="relative">
      ...
      /> */}
      <svg
        className="sm:hidden block w-full absolute leftRightFixer1 thordekhkr bottom-[-3.84615384615vw]"
        xmlns="http://www.w3.org/2000/svg"
        width="392.647"
        height="221.402"
      ...
      <div className="lg:mt-[5.72916666667vw] Container1440 relative z-[2] flex justify-between items-center flex-wrap gap-y-[6.15384615385vw] lg:py-[4.6875vw] pt-[14.358974359vw] pb-[16.6666666667vw] sm:py-[7.317073170731707vw]">
        <div className="lg:w-[32.7604166667vw]">
          {arabic ? (
            ...
            >
              <span className="PingAR-Bold"> نضعك </span> في قلب رحلة الرعاية
              الصحية الخاصة
        ...
        >
          <img
            src={
              arabic
                ? "/images/services/wellbeing-program-ar.png"
                : "/images/services/wellbeing-program.png"
            }
