...
const Pagination = () => {
  ...
  >
    ...
    <div className="flex lg:gap-x-[0.83333333333vw] gap-x-[2.5641025641vw]">
      <div className="number active relative lg:w-[2.5vw] w-[7.17948717949vw] flex justify-center items-center">
        <span className="text-[#313D49] PingAR-Light lg:text-[1.2vw] text-[3.58974358974vw] lg:h-[1.14583333333vw] h-[4.87179487179vw] block">
          1
        </span>
        <img
      ...
      <div className="number relative lg:w-[2.5vw] w-[7.17948717949vw] flex justify-center items-center">
        <span className="text-[#313D49] PingAR-Light lg:text-[1.2vw] text-[3.58974358974vw] lg:h-[1.14583333333vw] h-[4.87179487179vw] block">
          2
        </span>
        <img
    ...
    <svg
      className="flipped active  lg:w-[2.1875vw] w-[6.15384615385vw] transition-all duration-300"
      xmlns="http://www.w3.org/2000/svg"
      width={42}
      height={42}
      viewBox="0 0 42 42"
