...
const NewsCards = ({ arabic, data, isHome }) => {
  return (
    <div
      id="newsCards"
      className="sm:gap-[3.65853658537vw] baap lg:pt-[2.5vw] sm:py-[7.31707317073vw] pt-[8.20512820513vw] flex lg:gap-[2.5vw] gap-[4.10256410256vw] flex-wrap lg:pb-[3.33333333333vw] pb-[8.20512820513vw]"
    >
      {/* {arabic
