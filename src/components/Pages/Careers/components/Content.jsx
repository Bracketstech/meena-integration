...
const Content = ({ arabic }) => {
  return (
    <div className="lg:w-[28.3854166667vw]">
      ...
      >
        {arabic
          ? "من خلال توظيف أولئك الذين لديهم شغف حقيقي بالرعاية الصحية ، أنشأنا مجموعة متنوعة ومتحركة من الخبراء يركزون على الارتقاء برحلة الرعاية الصحية داخل المملكة ، انضم إلينا لإحداث تأثير"
          : "   By hiring those with a real passion for healthcare, we`&apos;ve created a varied  and driven group of experts focused on elevating the healthcare journey within the Kingdom, join us to make an impact"}
      </p>
      <a
        data-aos="fade"
        data-aos-anchor="#hiring"
