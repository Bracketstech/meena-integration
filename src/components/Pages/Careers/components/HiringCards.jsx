  ...
  return (
    ...
    >
      ...
      <div className="lg:mt-[0.625vw] mt-[3.07692307692vw] sm:mt-[1.46341463415vw]">
        ...
        <p className="sm:text-[1.9512195122vw] sm:leading-[3.41463414634vw] sm:mt-[unset] lg:mt-[0.41666666666vw] mt-[2.05128205128vw] PingAR-Light lg:text-[0.9375vw] text-[3.58974358974vw] text-[#505050] lg:leading-[1.47569444444vw] leading-[6.05128205128vw]">
          Lorem ipsum dolor sit amet, pscing consetetur sadipscing elitr, sed
