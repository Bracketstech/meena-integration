     ...
     {arabic? <>
      ...
      <div className="sm:text-[2.19512195122vw] sm:leading-[3.65853658537vw] sm:mt-[1.46341463415vw] sm:gap-y-[1.46341463415vw] lg:mt-[0.625vw] mt-[3.07692307692vw] text-[#505050] lg:text-[1.14583333333vw] lg:leading-[1.70572916667vw] text-[3.58974358974vw] leading-[6.06837606838vw] flex flex-col lg:gap-y-[0.83333333333vw] gap-y-[3.07692307692vw]">
        <p className="PingAR-Light">
          {arabic?"لهذا السبب نحدد نموذجًا جديدًا لرفاهية الإنسان ، ونرسم المسارات التي تؤدي إلى أفضل أيامك بما يتماشى مع رؤية 2030. نظامنا البيئي ذكي ومتكامل ومصمم وفقًا لاحتياجاتك - كما ينبغي أن يكون كما نعلم كل شخص فريد.": "That’s why we’re defining a new paradigm for human well-being, laying the tracks that lead to your best days in line with Vision 2030. Our ecosystem is smart, integrated, and made around your needs – as it should be since we know each person is unique."}
        </p>
        <p className="PingAR-Light">
         {arabic?"نحن في مكانك ، في أي مكان مألوف في حيك أو في راحة يدك. معًا ، تبني إمكاناتك.": " We’re where you are, in any familiar place in your neighborhood or in the palm of your hand. Together, embrace your potential."}
        </p>
      </div>
      ...
      <p className="sm:text-[2.19512195122vw] sm:leading-[3.65853658537vw] sm:mt-[1.46341463415vw] lg:mt-[0.625vw] mt-[3.07692307692vw] PingAR-Regular text-[#505050] lg:text-[1.14583333333vw] lg:leading-[1.70572916667vw] text-[3.58974358974vw] leading-[6.06837606838vw]">
       { arabic?"نحن نرسم الطريق الواضح لإطلاق العنان لإمكانياتك الكاملة":" We chart the clear path to unlock your full potential"}
      </p>
    </div>
  </div>
  <div
