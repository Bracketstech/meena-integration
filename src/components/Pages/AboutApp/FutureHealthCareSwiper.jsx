...
const FutureHealthCareSwiper = ({ arabic }) => {
  ...
  useEffect(() => {
    ...
    setSlidesPerView(
      window.innerWidth > 1024 ? 1 : window.innerWidth > 640 ? 2.5 : 1
    );
  }, []);
  return (
    <>
      ...
      >
        {arabic ? (
          <>
            اختبر
            <span className="PingAR-Bold"> مستقبل </span>
            الرعاية
            <br /> الصحية
          </>
        ) : (
              ...
              <div className="flex items-center justify-center lg:gap-x-[4.21875vw] flex-col lg:flex-row gap-y-[4.10256410256vw]">
                ...
                <div className="sm:w-full lg:w-[32.2916666667vw] w-[88.7179487179vw] flex flex-col items-center lg:items-start">
                  <img
                    data-aos="fade"
                    data-aos-delay={400}
                    src="/images/icons/check-board.svg"
                    alt="check-board"
                  ...
                  >
                    {arabic
                      ? "تحقق من الأعراض الخاصة بك في أي وقت"
                  ...
                  >
                    {arabic
                      ...
                      : "Intuitive health tool designed to help you quickly and easily assess your symptoms. By inputting your current health concerns, the symptom checker evaluates possible causes and offers guidance on potential next steps such as whether you should seek further medical advice or recommend you an educational content"}
                  </p>
                </div>
              </div>
            </SwiperSlide>
