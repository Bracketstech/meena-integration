...
const OurFeatures = ({arabic}) => {
  ...
  <div className="lg:pt-[2.5vw] pt-[6.15384615385vw] sm:pt-[4.87804878049vw] flex items-center justify-between flex-wrap lg:gap-x-[9.58333333333vw] lg:gap-y-[2.8125vw] lg:pb-[10.4166666667vw] pb-[20.5128205128vw] sm:pb-[14.6341463415vw] sm:gap-y-[2.92682926829vw] gap-y-[6.15384615385vw]">
    ...
    >
      <img
        src="/images/about-app/features/1.svg"
        alt="features"
    ...
    <div
      data-aos="fade"
      data-aos-delay={200}
      className="w-[43.5897435897vw] min-w-[43.5897435897vw] lg:min-w-[11.3541666667vw] lg:w-[11.3541666667vw] flex flex-col items-center lg:gap-y-[0.98958333333vw] gap-y-[2.05128205128vw]"
    >
      <img
        src="/images/about-app/features/2.svg"
        alt="features"
    ...
    <div
      data-aos="fade"
      data-aos-delay={400}
      className="w-[37.4358974359vw] min-w-[37.4358974359vw] lg:min-w-[8.33333333333vw] lg:w-[8.33333333333vw] flex flex-col items-center lg:gap-y-[0.98958333333vw] gap-y-[2.05128205128vw]"
    >
      <img
        src="/images/about-app/features/3.svg"
        alt="features"
    ...
    <div
      data-aos="fade"
      data-aos-delay={600}
      className="w-[43.5897435897vw] min-w-[43.5897435897vw] lg:min-w-[8.64583333333vw] lg:w-[8.64583333333vw] flex flex-col items-center lg:gap-y-[0.98958333333vw] gap-y-[2.05128205128vw]"
    >
      <img
        src="/images/about-app/features/4.svg"
        alt="features"
    ...
    >
      <img
        src="/images/about-app/features/5.svg"
        alt="features"
    ...
    >
      <img
        src="/images/about-app/features/6.svg"
        alt="features"
    ...
    >
      <img
        src="/images/about-app/features/7.svg"
        alt="features"
        className="lg:w-[2.5vw] w-[8.20512820513vw] sm:w-[4.87804878049vw]"
      />
      <span className="sm:text-[1.9512195122vw] sm:leading-[3.41463414634vw] lg:text-[0.9375vw] lg:leading-[1.51041666667vw] PingAR-Regular text-[#3B3659] text-[3.58974358974vw] leading-[5.64102564103vw] text-center">
    ...
    >
      <img
        src="/images/about-app/features/8.svg"
        alt="features"
        className="lg:w-[2.5vw] w-[8.20512820513vw] sm:w-[4.87804878049vw]"
      />
      <span className="sm:text-[1.9512195122vw] sm:leading-[3.41463414634vw] lg:text-[0.9375vw] lg:leading-[1.51041666667vw] PingAR-Regular text-[#3B3659] text-[3.58974358974vw] leading-[5.64102564103vw] text-center">
    ...
    >
      <img
        src="/images/about-app/features/9.svg"
        alt="features"
        className="lg:w-[2.5vw] w-[8.20512820513vw] sm:w-[4.87804878049vw]"
      />
      <span className="sm:text-[1.9512195122vw] sm:leading-[3.41463414634vw] lg:text-[0.9375vw] lg:leading-[1.51041666667vw] PingAR-Regular text-[#3B3659] text-[3.58974358974vw] leading-[5.64102564103vw] text-center">
    ...
    >
      <img
        src="/images/about-app/features/10.svg"
        alt="features"
    ...
    >
      <img
        src="/images/about-app/features/11.svg"
        alt="features"
        className="lg:w-[1.875vw] w-[6.15384615385vw] sm:w-[4.87804878049vw]"
      />
      <span className="sm:text-[1.9512195122vw] sm:leading-[3.41463414634vw] lg:text-[0.9375vw] lg:leading-[1.51041666667vw] PingAR-Regular text-[#3B3659] text-[3.58974358974vw] leading-[5.64102564103vw] text-center">
    ...
    >
      <img
        src="/images/about-app/features/12.svg"
        alt="features"
