  ...
  return (
    ...
    >
      <div className=" sm:h-full sm:w-[90%] sm:gap-y-[1.46341463415vw] w-[76.6666666667vw] gap-y-[2vw] lg:w-[19.1666666667vw] h-full justify-between mx-[auto] flex flex-col lg:gap-y-[0.41666666666vw]">
        <h4 className="lg:min-h-[4.3vw] sm:text-[2.68292682927vw] sm:leading-[3.90243902439vw] text-[4.871794871794872vw] lg:text-[1.354166666666667vw] lg:leading-[1.875vw] PingAR-Bold text-[#845FFF] flex-grow-[1]">
