        ...
        <div className="flex justify-end lg:justify-[normal]">
          <div className="lg:w-[75vw] w-[93%] lg:mx-[auto]">
            ...
            {swiperGap == 0 || (
              ...
              >
                <SwiperSlide className="swiper-slide lg:rounded-[1.04166666667vw] rounded-[20px] bg-[#F5EBE8]">
                  <div
                  ...
                  >
                    <div className="relative">
                      <p className="sm:text-[2.19512195122vw] sm:leading-[3.65853658537vw] lg:text-[1.14583333333vw] lg:leading-[1.666666666666667vw] text-[3.58974358974359vw] leading-[6.153846153846154vw] PingAR-Regular text-[#505050]">
                        {arabic
                          ? "لوريم ايبسوم دولار سيت أميت ,كونس يكتيتور أدايبا يسكينج أليايت,سيت دو أيوسمود . يوت انيم أد مينيم فينايم,كيواس نوستريد كسير سيتاشن يللأمكو"
                          : "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, seddiam nonumy eirmod tempor invidunt ut labore et dolore magna"}
                      </p>
                      <img
                        src={`/images/icons/${
