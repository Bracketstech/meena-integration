...
export default function Error({ error, reset }) {
  ...
  return (
    <div className="ltr flex flex-col min-h-screen">
      <header
      ...
      <div className="Container1680 lg:pt-[11vw] sm:pt-[24.3902439024vw] pt-[40.7692307692vw]  pb-[15vw] sm:pb-[10vw] lg:pb-[7vw] flex-grow flex flex-col justify-center">
    ...
    /> */}
          ...
          <img
            ...
            alt="footerbg-design"
            className="sm:w-[30.487804878vw]   flipped sm:hidden block w-[35.64102564102564vw] absolute leftRightFixer2 bottom-0"
          />
        ...
        <div className="bg-[#474166] lg:py-[0.390625vw] py-[3.205128205128205vw]">
          <div className="sm:text-[1.82926829268vw] flex justify-center sm:leading-[2.68292682927vw] PingAR-Regular Container1680 flex items-center justify-center   text-[#E6E7E7] lg:text-[0.8333333333333333vw] lg:leading-[1.45833333333vw] text-[2.564102564102564vw]">
            <span>All Rights Reserved. Meena Health @ 2023</span>
          </div>
        </div>
      </footer>
    </div>
